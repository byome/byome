    ...
    var randomScalingFactor = function() {
      ...
      //Get the canvas element
		...
		function polarChart(){
			...
			var color2 = tinycolor( App.color.primary ).lighten( 10 );
			var color3 = tinycolor( App.color.primary ).lighten( 20 );
			var color4 = tinycolor( App.color.primary ).lighten( 30 );
      var color5 = tinycolor( App.color.primary ).lighten( 40 );
